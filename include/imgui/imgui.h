...
namespace ImGui
{
	...
	IMGUI_API bool          SliderFloatPos(const char* label, float v[3], float v_min, float v_max, const char* display_format1 = "X = %.3f", const char* display_format2 = "Y = %.3f", const char* display_format3 = "Z = %.3f", float power = 1.0f);

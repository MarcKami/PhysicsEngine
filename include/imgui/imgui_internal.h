...
namespace ImGui
{
	...
	IMGUI_API bool          SliderFloatM(const char* label, float* v, int components, float v_min, float v_max, const char* display_format1, const char* display_format2, const char* display_format3, float power);
